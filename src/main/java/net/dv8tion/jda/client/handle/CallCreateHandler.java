    ...
    protected String handleInternally(JSONObject content)
    {
        ...
        if (channel instanceof Group)
        {
            ...
            if (group.getCurrentCall() != null)
                WebSocketClient.LOG.error(api.getShardMarker(), "Received a CALL_CREATE for a Group that already has an active call cached! JSON: {}", content);
        ...
        else
        {
            ...
            if (priv.getCurrentCall() != null)
                WebSocketClient.LOG.error(api.getShardMarker(), "Received a CALL_CREATE for a PrivateChannel that already has an active call cached! JSON: {}", content);
